 ...
 * 3. enableCors() → allows the Next.js frontend to call this backend
 * 4. ValidationPipe → validates all request bodies using DTO rules
 * 5. app.listen() → starts the HTTP server on port 4000
 */
async function bootstrap() {
   ...
   * -------------------------------------
   * Without this, browsers block requests from localhost:3000 to localhost:4000.

...
exports.CreateProjectPipelineTables1760000000000 = void 0;
class CreateProjectPipelineTables1760000000000 {
    constructor() {
        this.name = "CreateProjectPipelineTables1760000000000";
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_pipeline_runs_project_id" ON "project_pipeline_runs" ("project_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_pipeline_runs_triggered_by_user_id" ON "project_pipeline_runs" ("triggered_by_user_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_pipeline_events_pipeline_run_id" ON "project_pipeline_events" ("pipeline_run_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_pipeline_events_project_id" ON "project_pipeline_events" ("project_id")`);
        await queryRunner.query(`
      DO $$ BEGIN
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`DROP TYPE IF EXISTS "public"."project_pipeline_runs_status_enum"`);
    }
}
exports.CreateProjectPipelineTables1760000000000 = CreateProjectPipelineTables1760000000000;
//# sourceMappingURL=1760000000000-CreateProjectPipelineTables.js.map
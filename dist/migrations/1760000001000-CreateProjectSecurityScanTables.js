...
exports.CreateProjectSecurityScanTables1760000001000 = void 0;
class CreateProjectSecurityScanTables1760000001000 {
    constructor() {
        this.name = "CreateProjectSecurityScanTables1760000001000";
    }
    ...
    `);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_security_scans_project_id" ON "project_security_scans" ("project_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_security_scans_pipeline_run_id" ON "project_security_scans" ("pipeline_run_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_security_findings_scan_id" ON "project_security_findings" ("scan_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_security_findings_project_id" ON "project_security_findings" ("project_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_security_findings_pipeline_run_id" ON "project_security_findings" ("pipeline_run_id")`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_project_security_findings_vulnerability_id" ON "project_security_findings" ("vulnerability_id")`);
        await queryRunner.query(`
      DO $$ BEGIN
...
exports.CreateProjectSecurityScanTables1760000001000 = CreateProjectSecurityScanTables1760000001000;
//# sourceMappingURL=1760000001000-CreateProjectSecurityScanTables.js.map
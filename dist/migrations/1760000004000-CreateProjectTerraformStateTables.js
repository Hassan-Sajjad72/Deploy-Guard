...
exports.CreateProjectTerraformStateTables1760000004000 = void 0;
class CreateProjectTerraformStateTables1760000004000 {
    constructor() {
        this.name = "CreateProjectTerraformStateTables1760000004000";
    }
    ...
    async addPipelineStatus(queryRunner, status) {
        await queryRunner.query(`
      DO $$ BEGIN
    ...
    async addForeignKey(queryRunner, tableName, constraintName, columnName, referencedTableName, referencedColumnName, onDelete) {
        await queryRunner.query(`
      DO $$ BEGIN
...
exports.CreateProjectTerraformStateTables1760000004000 = CreateProjectTerraformStateTables1760000004000;
//# sourceMappingURL=1760000004000-CreateProjectTerraformStateTables.js.map
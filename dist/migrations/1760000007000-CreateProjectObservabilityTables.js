...
exports.CreateProjectObservabilityTables1760000007000 = void 0;
class CreateProjectObservabilityTables1760000007000 {
    constructor() {
        this.name = "CreateProjectObservabilityTables1760000007000";
    }
    ...
    async addForeignKey(queryRunner, tableName, constraintName, columnName, referencedTable, referencedColumn, onDelete) {
        const exists = await queryRunner.query(`SELECT 1 FROM information_schema.table_constraints WHERE constraint_name = $1 AND table_name = $2`, [constraintName, tableName]);
        if (exists.length > 0) {
            return;
        }
        await queryRunner.query(`
...
exports.CreateProjectObservabilityTables1760000007000 = CreateProjectObservabilityTables1760000007000;
//# sourceMappingURL=1760000007000-CreateProjectObservabilityTables.js.map